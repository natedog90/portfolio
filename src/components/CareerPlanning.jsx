  ...
  return (
    <>
      ...
      <nav className="navbar-clean">
        ...
        <h1 className="signature-name">Career Planning</h1>
        <a
        ...
        <div className="page-content">
          ...
          <div className="content-card">
            ...
            <p>
              ...
              career devolopement, while brandie our program manager taught us
              the buisness apect and how to be professional. Their mentorship
